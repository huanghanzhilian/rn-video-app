...
* @Last Modified time: 2018-04-20 17:55:20
*/
/*
* @Author: huanghanzhilian
...
export default class collect extends Component {
  ...
  render() {
  	var tag=['getTaginformation']
    if (this.state.renderPlaceholderOnly) {
      return this._renderPlaceholderView();
    }
    return (
      <View style={styles.container}>
      	<Head title='资讯' navigator={this.props.navigator} />
      	
        <VideoList {...this.props} api='getInformation' tag={tag} />
      </View>
    );
  }
}
